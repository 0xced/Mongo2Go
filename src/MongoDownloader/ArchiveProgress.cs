    ...
    public class ArchiveProgress : IProgress<ICopyProgress>
    {
        ...
        public void Report(ICopyProgress progress)
        {
            ...
            else
            {
                ...
                // remaining tasks (stripping) to complete with an indeterminate p  rogress bar
        ...
        public void ReportCompleted()
        {
            ...
            Report($"Extracted {_download.Product} for {_download.Platform}", isIndeterminate: false);
        }
