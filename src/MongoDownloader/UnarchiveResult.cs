...
/// <param name="DownloadBytesSaved">The number of bytes that were not downloaded in a zip file or <see langword="null"/> if unknown (because the HTTP Content-Length header was missing).</param>
